...
![MiContable — Tus finanzas, en equilibrio](public/micontable-og.png)
...
Una conexión bancaria real requeriría un proveedor AISP autorizado con cobertura de Ibercaja, OAuth/SCA, almacenamiento cifrado de tokens en servidor y revisión legal PSD2/RGPD. MiContable no solicita credenciales bancarias ni utiliza scraping.
